...
After that, please apply and install Novoalign by yourself. And link novoalign.lic (license file) and the binary files of novoalign, python2, and python3 to the db/ folder. HLAPro will use them by default.
