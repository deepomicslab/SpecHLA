...
```
Perform HLA typing with only paired-end data.
```
...
* Python libraries: Numpy, Pulp, Pysam, and Bio. 
* Perl 5 or above
...
Please apply Novoalign, and link novoalign.lic (license file) and the bin/ folder.
