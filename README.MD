...
- If you want to run SpecHLA with `only` long-read data, these is no need for the `Novoalign` licence. 
...
3. **After typing from diploid assmebly, an example for `<sample>_extracted_HLA_alleles.fasta` is as below:**
```
