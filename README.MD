...
You need only construct the environment from `conda env create --prefix=./spechla_env -f long_only_env.yml`. To extract HLA-related reads, pls use the full environment.
